import { IQuote } from "./quotesController"
...
const quotes = [{
  ...
  "text": "If you don’t see it in the data, don’t build the model."
},{
...
const updateQuote = async (quoteId:string, author:string, text:string,category:string) => {
